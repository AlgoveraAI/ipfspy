# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/02_httpapi.ipynb (unless otherwise specified).
...
__all__ = ['add_items', 'ls_items', 'get_items', 'cat_items', 'dag_export', 'dag_get', 'dag_stat', 'pin_add', 'pin_ls',
           ...
           'block_rm', 'block_stat', 'node_info', 'mfs_chcid', 'mfs_cp', 'mfs_flush', 'mfs_ls', 'mfs_mkdir', 'mfs_mv',
           'mfs_read', 'mfs_rm', 'mfs_stat', 'mfs_write', 'get_peers', 'dht_find_peer', 'dht_value_provider',
           'dht_get_value']
...
def node_info(
    ...
    **kwargs
    ...
    response = requests.post(f'{coreurl}/id', params=params)
